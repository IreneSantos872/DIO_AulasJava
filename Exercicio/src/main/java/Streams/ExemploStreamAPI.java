...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        //Retorna uma nova coleção, com os nomes concatenados a qtde de letra de cada nome
        System.out.println("Retorna uma nova coleção com a qtde de letras: " +
        ...
        System.out.println("Retorna os 3 elementos: " + estudantes.stream().limit(3).collect(Collectors.toList()));
        ...
        //Retorna true se todos os elementos possuem a letra minuscula no nome
        System.out.println("Tem algum elemento com a minuscula no nome: " + estudantes.stream().anyMatch((elemento) -> elemento.contains("a")));

        //Retorna true se todos os elementos possuem a letra minuscula no nome usando noneMatch
        ...
        estudantes.stream().findAny().ifPresent(System.out::println);
